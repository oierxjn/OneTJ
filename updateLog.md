...
---
Version: 2.5.0
Build Time: 2026.08.17-11:34

### Update Log:
+ 新增大学英语四、六级成绩查询功能，支持查询笔试与口试成绩
+ 新增我的考试查询功能，查看本学期考试时间、考场与课程考试安排
+ 新增主页布局选择，支持“底部导航”与“功能网格主页”两种模式，预设多套 3D 功能图标
+ 新增功能网格首页与返回主页按钮
* 优化窄屏四列功能网格布局适配
...
---
Version: 2.4.5
Build Time: 2026.06.28-00:00

### Update Log:
+ 新增弗兰克-赫兹实验功能，支持 160 组实验数据录入与自动分析（峰值法/谷值法/综合第一激发电位）
+ 新增主题颜色自定义功能，支持亮/暗双模式独立配色、跟随系统、5 套内置预设
+ 新增配色方案分享复制与从分享文本导入功能
+ 新增日志文件导出功能，支持保存到文件/导出到目录/打开已导出文件
+ 重构 Code2Token JSON 解析，支持字段级详细报错，异常信息自动脱敏 token 敏感字段
+ 重构启动页主题初始化流程，MaterialApp 接入 ListenableBuilder 响应主题变更
* 调整物理实验列表视图内边距和间距
