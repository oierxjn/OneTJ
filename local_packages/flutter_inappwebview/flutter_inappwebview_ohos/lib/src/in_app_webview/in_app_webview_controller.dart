...
/// Object specifying creation parameters for creating a [OhosInAppWebViewController].
///
/// When adding additional fields make sure they can be null or have a default
/// value to avoid breaking changes. See [PlatformInAppWebViewControllerCreationParams] for
/// more information.
@immutable
class OhosInAppWebViewControllerCreationParams
    extends PlatformInAppWebViewControllerCreationParams {
  /// Creates a new [OhosInAppWebViewControllerCreationParams] instance.
  const OhosInAppWebViewControllerCreationParams(
      {required super.id, super.webviewParams});

  /// Creates a [OhosInAppWebViewControllerCreationParams] instance based on [PlatformInAppWebViewControllerCreationParams].
  factory OhosInAppWebViewControllerCreationParams.fromPlatformInAppWebViewControllerCreationParams(
      // Recommended placeholder to prevent being broken by platform interface.
      // ignore: avoid_unused_constructor_parameters
      PlatformInAppWebViewControllerCreationParams params) {
    return OhosInAppWebViewControllerCreationParams(
        id: params.id, webviewParams: params.webviewParams);
  }
}

///Controls a WebView, such as an [InAppWebView] widget instance, a [OhosHeadlessInAppWebView] instance or [OhosInAppBrowser] WebView instance.
///
...
///callback. Instead, if you are using an [OhosInAppBrowser] instance, you can get it through the [OhosInAppBrowser.webViewController] attribute.
class OhosInAppWebViewController extends PlatformInAppWebViewController
  ...
  Set<OhosWebMessageChannel> _webMessageChannels = Set();
  Set<OhosWebMessageListener> _webMessageListeners = Set();
  ...
  OhosInAppBrowser? _inAppBrowser;
  ...
  @override
  late OhosWebStorage webStorage;

  OhosInAppWebViewController(
      PlatformInAppWebViewControllerCreationParams params)
      : super.implementation(params
                is OhosInAppWebViewControllerCreationParams
            ? params
            : OhosInAppWebViewControllerCreationParams
  ...
  static final OhosInAppWebViewController _staticValue =
      OhosInAppWebViewController(
          OhosInAppWebViewControllerCreationParams(id: null));

  factory OhosInAppWebViewController.static() {
    return _staticValue;
  }

  OhosInAppWebViewController.fromInAppBrowser(
      PlatformInAppWebViewControllerCreationParams params,
      MethodChannel channel,
      OhosInAppBrowser inAppBrowser,
      UnmodifiableListView<UserScript>? initialUserScripts)
      : super.implementation(
            params is OhosInAppWebViewControllerCreationParams
                ? params
                : OhosInAppWebViewControllerCreationParams
                    .fromPlatformInAppWebViewControllerCreationParams(params)) {
  ...
  void _init(PlatformInAppWebViewControllerCreationParams params) {
    ...
    webStorage = OhosWebStorage(OhosWebStorageCreationParams(
        localStorage: OhosLocalStorage.defaultStorage(controller: this),
        sessionStorage:
            OhosSessionStorage.defaultStorage(controller: this)));
    ...
    if (params.webviewParams is PlatformInAppWebViewWidgetCreationParams) {
      ...
      if (keepAlive != null) {
        ...
        if (props == null) {
          ...
          _webMessageChannels =
              props.webMessageChannels as Set<OhosWebMessageChannel>;
          _webMessageListeners =
              props.webMessageListeners as Set<OhosWebMessageListener>;
        }
      }
    }
  }
    ...
    switch (call.method) {
      ...
      case "onPrintRequest":
        if ((webviewParams != null &&
          ...
          WebUri? uri = url != null ? WebUri(url) : null;
          OhosPrintJobController? printJob = printJobId != null
              ? OhosPrintJobController(
                  OhosPrintJobControllerCreationParams(id: printJobId))
              : null;
...
"""))?.cast<Map<dynamic, dynamic>>() ?? [];
  ...
  @override
  Future<OhosPrintJobController?> printCurrentPage(
...
(function() {
  ...
  @override
  Future<OhosWebMessageChannel?> createWebMessageChannel() async {
    Map<String, dynamic> args = <String, dynamic>{};
    Map<String, dynamic>? result =
        (await channel?.invokeMethod('createWebMessageChannel', args))
            ?.cast<String, dynamic>();
    final webMessageChannel = OhosWebMessageChannel.static().fromMap(result);
  ...
  Future<void> addWebMessageListener(
    ...
    _webMessageListeners.add(webMessageListener as OhosWebMessageListener);
...
extension InternalInAppWebViewController on OhosInAppWebViewController {
