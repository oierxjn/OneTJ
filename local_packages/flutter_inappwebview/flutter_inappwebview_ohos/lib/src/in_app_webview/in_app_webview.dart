...
/// this class.
class OhosInAppWebViewWidgetCreationParams
    extends PlatformInAppWebViewWidgetCreationParams {
  OhosInAppWebViewWidgetCreationParams(
  ...
  /// Constructs a [OhosInAppWebViewWidgetCreationParams] using a
  /// [PlatformInAppWebViewWidgetCreationParams].
  OhosInAppWebViewWidgetCreationParams.fromPlatformInAppWebViewWidgetCreationParams(
...
class OhosInAppWebViewWidget extends PlatformInAppWebViewWidget {
  /// Constructs a [OhosInAppWebViewWidget].
  ///
  ///{@macro flutter_inappwebview_platform_interface.PlatformInAppWebViewWidget}
  OhosInAppWebViewWidget(PlatformInAppWebViewWidgetCreationParams params)
      : super.implementation(
          params is OhosInAppWebViewWidgetCreationParams
              ? params
              : OhosInAppWebViewWidgetCreationParams
  ...
  Widget build(BuildContext context) {
    ...
    // 这里对比安卓没有PlatformViewLink 暂时用OhosView替代
    return OhosView(
      key: params.key,
  ...
  OhosViewController _createOhosViewController({
