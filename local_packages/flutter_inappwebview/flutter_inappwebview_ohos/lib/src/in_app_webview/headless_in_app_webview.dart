...
/// Object specifying creation parameters for creating a [OhosHeadlessInAppWebView].
///
/// When adding additional fields make sure they can be null or have a default
/// value to avoid breaking changes. See [PlatformHeadlessInAppWebViewCreationParams] for
/// more information.
@immutable
class OhosHeadlessInAppWebViewCreationParams
    extends PlatformHeadlessInAppWebViewCreationParams {
  /// Creates a new [OhosHeadlessInAppWebViewCreationParams] instance.
  OhosHeadlessInAppWebViewCreationParams(
  ...
  /// Creates a [OhosHeadlessInAppWebViewCreationParams] instance based on [PlatformHeadlessInAppWebViewCreationParams].
  OhosHeadlessInAppWebViewCreationParams.fromPlatformHeadlessInAppWebViewCreationParams(
      ...
      : this(
            ...
            pullToRefreshController: params.pullToRefreshController
                as OhosPullToRefreshController?,
            findInteractionController: params.findInteractionController
                as OhosFindInteractionController?);

  @override
  final OhosFindInteractionController? findInteractionController;

  @override
  final OhosPullToRefreshController? pullToRefreshController;
}

///{@macro flutter_inappwebview_platform_interface.PlatformHeadlessInAppWebView}
class OhosHeadlessInAppWebView extends PlatformHeadlessInAppWebView
  ...
  OhosInAppWebViewController? _webViewController;

  /// Constructs a [OhosHeadlessInAppWebView].
  OhosHeadlessInAppWebView(PlatformHeadlessInAppWebViewCreationParams params)
      : super.implementation(
          params is OhosHeadlessInAppWebViewCreationParams
              ? params
              : OhosHeadlessInAppWebViewCreationParams
  ...
  @override
  OhosInAppWebViewController? get webViewController => _webViewController;

  dynamic _controllerFromPlatform;

  OhosHeadlessInAppWebViewCreationParams get _OhosParams =>
      params as OhosHeadlessInAppWebViewCreationParams;

  _init() {
    _webViewController = OhosInAppWebViewController(
    ...
    _controllerFromPlatform =
        params.controllerFromPlatform?.call(_webViewController!) ??
            _webViewController!;
    _OhosParams.pullToRefreshController?.init(id);
    _OhosParams.findInteractionController?.init(id);
    channel =
  ...
  Future<void> run() async {
    ...
    Map<String, dynamic> pullToRefreshSettings =
        _OhosParams.pullToRefreshController?.params.settings.toMap() ??
            _OhosParams.pullToRefreshController?.params.options.toMap() ??
  ...
  Future<void> dispose() async {
    ...
    _OhosParams.pullToRefreshController?.dispose();
    _OhosParams.findInteractionController?.dispose();
  }
}

extension InternalHeadlessInAppWebView on OhosHeadlessInAppWebView {
