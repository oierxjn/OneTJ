...
/// Object specifying creation parameters for creating a [OhosInAppBrowser].
///
/// When adding additional fields make sure they can be null or have a default
/// value to avoid breaking changes. See [PlatformInAppBrowserCreationParams] for
/// more information.
class OhosInAppBrowserCreationParams
    extends PlatformInAppBrowserCreationParams {
  /// Creates a new [OhosInAppBrowserCreationParams] instance.
  OhosInAppBrowserCreationParams(
      {super.contextMenu,
  ...
  /// Creates a [OhosInAppBrowserCreationParams] instance based on [PlatformInAppBrowserCreationParams].
  factory OhosInAppBrowserCreationParams.fromPlatformInAppBrowserCreationParams(
      // Recommended placeholder to prevent being broken by platform interface.
      // ignore: avoid_unused_constructor_parameters
      PlatformInAppBrowserCreationParams params) {
    return OhosInAppBrowserCreationParams(
        contextMenu: params.contextMenu,
        pullToRefreshController:
            params.pullToRefreshController as OhosPullToRefreshController?,
...
class OhosInAppBrowser extends PlatformInAppBrowser with ChannelController {
  @override
  final String id = IdGenerator.generate();

  /// Constructs a [OhosInAppBrowser].
  OhosInAppBrowser(PlatformInAppBrowserCreationParams params)
      : super.implementation(
          params is OhosInAppBrowserCreationParams
              ? params
              : OhosInAppBrowserCreationParams
  ...
  static final OhosInAppBrowser _staticValue =
      OhosInAppBrowser(OhosInAppBrowserCreationParams());

  /// Provide static access.
  factory OhosInAppBrowser.static() {
    return _staticValue;
  }

  OhosInAppBrowserCreationParams get _androidParams =>
      params as OhosInAppBrowserCreationParams;
  ...
  @override
  OhosInAppWebViewController? get webViewController {
  ...
  _init() {
    ...
    _webViewController = OhosInAppWebViewController.fromInAppBrowser(
        OhosInAppWebViewControllerCreationParams(id: id),
        channel!,
        this,
...
extension InternalInAppBrowser on OhosInAppBrowser {
