...
/// Object specifying creation parameters for creating a [OhosChromeSafariBrowser].
///
/// When adding additional fields make sure they can be null or have a default
/// value to avoid breaking changes. See [PlatformChromeSafariBrowserCreationParams] for
/// more information.
@immutable
class OhosChromeSafariBrowserCreationParams
    extends PlatformChromeSafariBrowserCreationParams {
  /// Creates a new [OhosChromeSafariBrowserCreationParams] instance.
  const OhosChromeSafariBrowserCreationParams();

  /// Creates a [OhosChromeSafariBrowserCreationParams] instance based on [PlatformChromeSafariBrowserCreationParams].
  factory OhosChromeSafariBrowserCreationParams.fromPlatformChromeSafariBrowserCreationParams(
      // Recommended placeholder to prevent being broken by platform interface.
      // ignore: avoid_unused_constructor_parameters
      PlatformChromeSafariBrowserCreationParams params) {
    return OhosChromeSafariBrowserCreationParams();
  }
}

///{@macro flutter_inappwebview_platform_interface.PlatformChromeSafariBrowser}
class OhosChromeSafariBrowser extends PlatformChromeSafariBrowser
    with ChannelController {
  @override
  final String id = IdGenerator.generate();

  /// Constructs a [OhosChromeSafariBrowser].
  OhosChromeSafariBrowser(PlatformChromeSafariBrowserCreationParams params)
      : super.implementation(
          params is OhosChromeSafariBrowserCreationParams
              ? params
              : OhosChromeSafariBrowserCreationParams
                  .fromPlatformChromeSafariBrowserCreationParams(params),
        );

  static final OhosChromeSafariBrowser _staticValue =
      OhosChromeSafariBrowser(OhosChromeSafariBrowserCreationParams());

  /// Provide static access.
  factory OhosChromeSafariBrowser.static() {
    return _staticValue;
  }
